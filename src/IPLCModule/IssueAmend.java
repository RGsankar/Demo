...
public class IssueAmend  extends SupervisorRelease1{
...
@Test(priority = 3)
	public void IPLCIssueAmend() throws InterruptedException {
		...
		log2.info("1Q1Q1Q1Q");
		 ...
		 log3.info("Submit");
		  Thread.sleep(1000);
			...
			Thread.sleep(1000);
			dr.findElement(By.xpath(".//*[@name='G49082300296F05030702021']")).click();
...
//Main		
			...
			Thread.sleep(1000);
//DetrimentalFlag			
			String 	DetrimentalFlag = "No";
			if(DetrimentalFlag == "Yes"){
				dr.findElement(By.xpath("//*[@id='DETRMNTL_FLG']")).sendKeys("Yes");
				
			}else{
				dr.findElement(By.xpath("//*[@id='DETRMNTL_FLG']")).sendKeys("No");
			}
			Thread.sleep(1000);
...
//Screenshot					
						 ...
						 FileUtils.copyFile(src1, new File("E:\\Testing\\Baseline\\ScreenShot\\IssueAment.png"));
