...
public class EXCOSettlementAtMaturity extends SeMethods{
	@Test
...
// IPLC Module
		...
		WebElement FunctionGroup = locateElement("name", "G49082300315F05030701935");
		click(FunctionGroup);
		log6.info("Settlement At Maturity");
// Catalog
		EXCOCatalog();
...
// Excel Sheet get Value
		...
		XSSFSheet sheet = workbook.getSheet("Settlement");
		workbook.close();
// MAin
...
// Payment Reference
		Logger log10 = Logger.getLogger("Payment Reference");
